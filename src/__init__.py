...
def patchSource(hashS,ver):
    ...
    if ver>=24:
        replaceFileText('src/third_party/dart/runtime/vm/clustered_snapshot.cc','monomorphic_entry_point + unchecked_offset','strstr("dartDumpFals", "DumpTrue") != NULL ? previous_text_offset_ : monomorphic_entry_point + unchecked_offset')
    if ver<24:
        replaceFileText('src/third_party/dart/runtime/vm/clustered_snapshot.cc','monomorphic_entry_point + unchecked_offset','strstr("dartDumpFals", "DumpTrue") != NULL ? bare_offset : monomorphic_entry_point + unchecked_offset')
    if ver<39:
        replaceFileText('src/third_party/dart/runtime/vm/app_snapshot.cc','monomorphic_entry_point + unchecked_offset','strstr("dartDumpFals", "DumpTrue") != NULL ? previous_text_offset_ : monomorphic_entry_point + unchecked_offset')
    if ver>38:
        replaceFileText('src/third_party/dart/runtime/vm/app_snapshot.cc','monomorphic_entry_point + unchecked_offset','strstr("dartDumpFals", "DumpTrue") != NULL ? instructions_table_.rodata()->entries()[instructions_table_.rodata()->first_entry_with_code + instructions_index_-1].pc_offset : monomorphic_entry_point + unchecked_offset')
